...
%%DVI.Maker=live_tex_dvi
%EndFileInfo

%pdftex
\documentclass[draft,pdftex]{ectaart}
...
\begin{aug}
\author{\fnms{First} \snm{Author}\thanksref{a,t1}\ead[label=e1]{first@somewhere.com}}
\author{\fnms{Second} \snm{Author}\thanksref{a}\ead[label=e2]{second@somewhere.com}}
\author{\fnms{Third} \snm{Author}\thanksref{b}
\ead[label=e3]{third@somewhere.com}
\ead[label=u1,url]{www.foo.com}}

\thankstext{t1}{Some comment}
\runauthor{F. Author, S. Author and T. Author}

\address[a]{Address of the First and Second authors,
...
\address[b]{Address of the Third author,
usually few lines long,
usually few lines long\\
\printead{e3,u1}}
\end{aug}
...
than 150 words. It should also be suitable for publication in
